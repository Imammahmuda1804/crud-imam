            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                ...
                <div class="flex flex-col items-center justify-center">
                    ...
                    <div id="image-preview-wrapper" class="w-full max-w-xs cursor-pointer">
                        {{-- Placeholder dan Preview sekarang berada di dalam satu container --}}
                        <div class="file-input-placeholder w-full aspect-[2/3] bg-gray-50 border-2 border-gray-300 rounded-lg flex items-center justify-center text-center p-4">
                            ...
                            {{-- Tag img sekarang berada di dalam, dengan posisi absolut --}}
...
<script>
    ...
    // Klik pada area placeholder juga akan memicu input file
    ...
    coverImageInput.addEventListener('change', function(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                // Kita tidak perlu lagi menyembunyikan placeholder, karena gambar akan menutupinya
            }
